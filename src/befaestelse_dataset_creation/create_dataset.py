...
def main(args):
    ...
    if not "create_labels" in args.skip:
        ...
        create_label_images.main(config=r"..\..\configs\template_create_labels.ini")
    if not "create_patches" in args.skip:
        ...
        create_patches.main(config=r"..\..\configs\template_create_patches.ini")
    if not "remove_empty_label_images" in args.skip:
        ...
        delete_images_with_only_zeroes.main(config=r"..\..\configs\template_create_patches.ini")
